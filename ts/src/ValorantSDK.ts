...
class ValorantSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('ValorantSDK: graphql: ' +
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Competitive(entopts?: Record<string, any>) {
    const self = this
    return new CompetitiveEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Cosmetic(entopts?: Record<string, any>) {
    const self = this
    return new CosmeticEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  GameMode(entopts?: Record<string, any>) {
    const self = this
    return new GameModeEntity(self, entopts)
  }
