...
describe('exists', async () => {
  ...
  //
  // ValorantSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof ValorantSDK, true,
      'ValorantSDK.test() must return a client synchronously')
  })
