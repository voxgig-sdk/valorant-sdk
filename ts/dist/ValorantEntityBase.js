...
exports.ValorantEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends ValorantEntityBase<Advice>`.
class ValorantEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.ValorantEntityBase = ValorantEntityBase;
//# sourceMappingURL=ValorantEntityBase.js.map