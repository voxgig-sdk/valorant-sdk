...
function envOverride(m) {
    if ('TRUE' === process.env.VALORANT_TEST_LIVE ||
        'TRUE' === process.env.VALORANT_TEST_OVERRIDE) {
    ...
    m.VALORANT_TEST_EXPLAIN = process.env.VALORANT_TEST_EXPLAIN || m.VALORANT_TEST_EXPLAIN;
    return m;
}
