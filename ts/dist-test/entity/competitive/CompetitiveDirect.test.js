...
(0, node_test_1.describe)('CompetitiveDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-competitive', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-competitive', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VALORANT_TEST_COMPETITIVE_ENTID'];
...
//# sourceMappingURL=CompetitiveDirect.test.js.map