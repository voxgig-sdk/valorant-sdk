...
(0, node_test_1.describe)('CompetitiveEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/competitive/CompetitiveTestData.json');
    ...
    let idmap = transform(['competitive01', 'competitive02', 'competitive03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CompetitiveEntity.test.js.map