...
(0, node_test_1.describe)('MapDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-map', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-map', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-map', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-map', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VALORANT_TEST_MAP_ENTID'];
...
//# sourceMappingURL=MapDirect.test.js.map