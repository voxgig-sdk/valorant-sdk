...
(0, node_test_1.describe)('CosmeticDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-cosmetic', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-cosmetic', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VALORANT_TEST_COSMETIC_ENTID'];
...
//# sourceMappingURL=CosmeticDirect.test.js.map