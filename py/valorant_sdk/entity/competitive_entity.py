...
class CompetitiveEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CompetitiveEntity(self._client, opts)
    ...
    def match_get(self) -> Competitive:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Competitive]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Competitive().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
