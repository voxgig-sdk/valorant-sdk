...
from valorant_sdk.utility import register

# Load features
from valorant_sdk.feature.base_feature import ValorantBaseFeature
from valorant_sdk.features import _has_feature, _make_feature
...
class ValorantSDK:
    ...
    def get_utility(self):
        return ValorantUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ValorantSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Agent(self, data=None) -> "AgentEntity":
        ...
        from valorant_sdk.entity.agent_entity import AgentEntity
    ...
    def Competitive(self, data=None) -> "CompetitiveEntity":
        ...
        from valorant_sdk.entity.competitive_entity import CompetitiveEntity
    ...
    def Cosmetic(self, data=None) -> "CosmeticEntity":
        ...
        from valorant_sdk.entity.cosmetic_entity import CosmeticEntity
