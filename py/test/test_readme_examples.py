# Valorant SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ValorantSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ValorantSDK(...) and ValorantSDK.test(...) become
#      ValorantSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "valorant_sdk"
_SDK_CLASS = "ValorantSDK"
