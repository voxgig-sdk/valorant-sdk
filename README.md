...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/valorant` | `npm install @voxgig-sdk/valorant` |
| Python | `voxgig-sdk-valorant` | `pip install voxgig-sdk-valorant` |
| PHP | `voxgig-sdk/valorant` | `composer require voxgig-sdk/valorant` |
| Golang | `github.com/voxgig-sdk/valorant-sdk/go` | `go get github.com/voxgig-sdk/valorant-sdk/go` |
| Ruby | `voxgig-sdk-valorant` | `gem install voxgig-sdk-valorant` |
| Lua | `voxgig-sdk-valorant` | `luarocks install voxgig-sdk-valorant` |
