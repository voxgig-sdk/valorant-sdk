...
## Install
```bash
go get github.com/voxgig-sdk/valorant-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/valorant-sdk=../path/to/github.com/voxgig-sdk/valorant-sdk
```
...
```
github.com/voxgig-sdk/valorant-sdk/
...
The root package (`github.com/voxgig-sdk/valorant-sdk`) re-exports everything needed
