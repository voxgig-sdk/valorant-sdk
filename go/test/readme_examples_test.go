...
const testSeed = `map[string]any{"entity": map[string]any{"agent": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "competitive": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cosmetic": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "game_mode": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "map": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "weapon": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
