...
import (
	...
	vs "github.com/voxgig-sdk/valorant-sdk/go/utility/struct"
)

type CompetitiveEntity struct {
	name    string
	client  *core.ValorantSDK
...
func NewCompetitiveEntity(client *core.ValorantSDK, entopts map[string]any) *CompetitiveEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CompetitiveEntity) GetName() string { return e.name }
...
func (e *CompetitiveEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CompetitiveEntity) Deleted() bool {
	return e.deleted
}


func (e *CompetitiveEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCompetitiveEntity(e.client, opts)
}

func (e *CompetitiveEntity) Data(args ...any) any {
...
func (e *CompetitiveEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Competitive; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CompetitiveEntity) DataTyped(data ...Competitive) Competitive {
	if len(data) > 0 {
		return typedFrom[Competitive](e.Data(asMap(data[0])))
	}
	return typedFrom[Competitive](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Competitive (all fields
// optional at the wire level).
func (e *CompetitiveEntity) MatchTyped(match ...Competitive) Competitive {
	if len(match) > 0 {
		return typedFrom[Competitive](e.Match(asMap(match[0])))
	}
	return typedFrom[Competitive](e.Match())
}
...
func (e *CompetitiveEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CompetitiveEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CompetitiveEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CompetitiveListMatch and returns []Competitive. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CompetitiveEntity) ListTyped(reqmatch CompetitiveListMatch, ctrl map[string]any) ([]Competitive, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Competitive](res), nil
}



func (e *CompetitiveEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CompetitiveEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CompetitiveEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CompetitiveEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
