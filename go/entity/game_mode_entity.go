...
func NewGameModeEntity(client *core.ValorantSDK, entopts map[string]any) *GameModeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GameModeEntity) GetName() string { return e.name }
...
func (e *GameModeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GameModeEntity) Deleted() bool {
	return e.deleted
}


func (e *GameModeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGameModeEntity(e.client, opts)
}

func (e *GameModeEntity) Data(args ...any) any {
...
func (e *GameModeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GameMode; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GameModeEntity) DataTyped(data ...GameMode) GameMode {
	if len(data) > 0 {
		return typedFrom[GameMode](e.Data(asMap(data[0])))
	}
	return typedFrom[GameMode](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GameMode (all fields
// optional at the wire level).
func (e *GameModeEntity) MatchTyped(match ...GameMode) GameMode {
	if len(match) > 0 {
		return typedFrom[GameMode](e.Match(asMap(match[0])))
	}
	return typedFrom[GameMode](e.Match())
}
...
func (e *GameModeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GameModeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *GameModeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GameModeListMatch and returns []GameMode. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GameModeEntity) ListTyped(reqmatch GameModeListMatch, ctrl map[string]any) ([]GameMode, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GameMode](res), nil
}



func (e *GameModeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GameModeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GameModeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GameModeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
