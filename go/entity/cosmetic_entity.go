...
func NewCosmeticEntity(client *core.ValorantSDK, entopts map[string]any) *CosmeticEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CosmeticEntity) GetName() string { return e.name }
...
func (e *CosmeticEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CosmeticEntity) Deleted() bool {
	return e.deleted
}


func (e *CosmeticEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCosmeticEntity(e.client, opts)
}

func (e *CosmeticEntity) Data(args ...any) any {
...
func (e *CosmeticEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Cosmetic; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CosmeticEntity) DataTyped(data ...Cosmetic) Cosmetic {
	if len(data) > 0 {
		return typedFrom[Cosmetic](e.Data(asMap(data[0])))
	}
	return typedFrom[Cosmetic](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Cosmetic (all fields
// optional at the wire level).
func (e *CosmeticEntity) MatchTyped(match ...Cosmetic) Cosmetic {
	if len(match) > 0 {
		return typedFrom[Cosmetic](e.Match(asMap(match[0])))
	}
	return typedFrom[Cosmetic](e.Match())
}
...
func (e *CosmeticEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CosmeticEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CosmeticEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CosmeticListMatch and returns []Cosmetic. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CosmeticEntity) ListTyped(reqmatch CosmeticListMatch, ctrl map[string]any) ([]Cosmetic, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Cosmetic](res), nil
}



func (e *CosmeticEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CosmeticEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CosmeticEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CosmeticEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
