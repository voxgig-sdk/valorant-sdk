...
func NewMapEntity(client *core.ValorantSDK, entopts map[string]any) *MapEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MapEntity) GetName() string { return e.name }
...
func (e *MapEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MapEntity) Deleted() bool {
	return e.deleted
}


func (e *MapEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMapEntity(e.client, opts)
}

func (e *MapEntity) Data(args ...any) any {
...
func (e *MapEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Map; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MapEntity) DataTyped(data ...Map) Map {
	if len(data) > 0 {
		return typedFrom[Map](e.Data(asMap(data[0])))
	}
	return typedFrom[Map](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Map (all fields
// optional at the wire level).
func (e *MapEntity) MatchTyped(match ...Map) Map {
	if len(match) > 0 {
		return typedFrom[Map](e.Match(asMap(match[0])))
	}
	return typedFrom[Map](e.Match())
}
...
func (e *MapEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MapEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MapLoadMatch and returns an Map. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *MapEntity) LoadTyped(reqmatch MapLoadMatch, ctrl map[string]any) (Map, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Map{}, err
	}
	return typedFrom[Map](res), nil
}




func (e *MapEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// MapListMatch and returns []Map. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MapEntity) ListTyped(reqmatch MapListMatch, ctrl map[string]any) ([]Map, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Map](res), nil
}



func (e *MapEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MapEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MapEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MapEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
