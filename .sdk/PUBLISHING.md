...
|---|---|---|
| `ts/` | @voxgig-sdk/valorant-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/valorant-sdk \
      --repository voxgig-sdk/valorant-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/valorant-sdk` shows it, and
`npm trust revoke @voxgig-sdk/valorant-sdk --id=<id>` removes it.
