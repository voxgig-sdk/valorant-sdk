...
class ValorantTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ValorantTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ValorantTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ValorantTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
