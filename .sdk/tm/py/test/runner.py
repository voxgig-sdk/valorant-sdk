...
class ValorantTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ValorantTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = ValorantTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = ValorantTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
