...
from projectname_sdk import ValorantSDK
from projectname_sdk.core.spec import ValorantSpec
from projectname_sdk.core.result import ValorantResult
from projectname_sdk.core.response import ValorantResponse
from projectname_sdk.core.operation import ValorantOperation
from projectname_sdk.core.error import ValorantError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import ValorantBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = ValorantSDK.test(None, None)
        ...
        class TestInitFeature(ValorantBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(ValorantBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = ValorantSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ValorantSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ValorantSDK.test(None, setup_opts)
