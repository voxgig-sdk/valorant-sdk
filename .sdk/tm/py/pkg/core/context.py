...
from projectname_sdk.core.control import ValorantControl
...
class ValorantContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, ValorantResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ValorantResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ValorantError(code, msg, self)
