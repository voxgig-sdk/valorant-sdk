...
// Valorant SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ValorantMakeRequest
{
    public static function call(ValorantContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ValorantResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ValorantResponse($fetched);
        } else {
