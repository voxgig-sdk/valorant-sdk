...
class ValorantGraphql
{
    ...
    // equivalent.
    public static function body(ValorantContext $ctx): mixed
    {
    ...
    public static function errors(ValorantContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
