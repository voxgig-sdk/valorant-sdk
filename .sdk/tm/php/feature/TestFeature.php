...
// Valorant SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ValorantTestFeature extends ValorantBaseFeature
{
    ...
    public function init(ValorantContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ValorantContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ValorantContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ValorantContext $ctx, $op, $args): array
    {
