...
// Valorant SDK ratelimit feature
...
class ValorantRatelimitFeature extends ValorantBaseFeature
{
    ...
    private function _acquire(ValorantContext $ctx): void
    {
    ...
    private function _track(ValorantContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
