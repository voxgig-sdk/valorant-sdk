...
class ValorantTimeoutFeature extends ValorantBaseFeature
{
    ...
    private function _with_timeout(ValorantContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ValorantContext $_ctx, float $ms): void
    {
        $client = $this->client;
