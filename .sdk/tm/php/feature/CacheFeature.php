...
class ValorantCacheFeature extends ValorantBaseFeature
{
    ...
    private function _through(ValorantContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
