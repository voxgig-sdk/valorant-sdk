...
class ValorantRbacFeature extends ValorantBaseFeature
{
    ...
    private function _required(ValorantContext $ctx): ?string
    {
    ...
    private function _reject(ValorantContext $ctx, string $required): void
    {
    ...
    private function _track(ValorantContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
