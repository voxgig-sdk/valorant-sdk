...
class ValorantProxyFeature extends ValorantBaseFeature
{
    ...
    public function init(ValorantContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ValorantContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
