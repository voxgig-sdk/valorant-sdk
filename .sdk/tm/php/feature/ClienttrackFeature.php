...
// Valorant SDK clienttrack feature
...
class ValorantClienttrackFeature extends ValorantBaseFeature
{
    ...
    public function PostConstruct(ValorantContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Valorant-SDK';
