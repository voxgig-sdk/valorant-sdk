...
class ValorantNetsimFeature extends ValorantBaseFeature
{
    ...
    private function _simulate(ValorantContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ValorantContext $ctx, array $applied): void
    {
        $client = $this->client;
