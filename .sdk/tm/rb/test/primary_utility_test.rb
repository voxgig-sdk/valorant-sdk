...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = ValorantOmni.make_runner(TEST_JSON_FILE, ValorantSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : ValorantOmni.errify(err)
    end
