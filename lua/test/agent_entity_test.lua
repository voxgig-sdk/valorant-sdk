...
describe("AgentEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set VALORANT_TEST_AGENT_ENTID JSON to run live")
      return
    end
...
function agent_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("VALORANT_TEST_AGENT_ENTID")
