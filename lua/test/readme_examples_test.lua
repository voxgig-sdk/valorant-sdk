...
-- data to return.
local TEST_SEED = '{ entity = { ["agent"] = { ["test01"] = { id = "test01" } }, ["competitive"] = { ["test01"] = { id = "test01" } }, ["cosmetic"] = { ["test01"] = { id = "test01" } }, ["game_mode"] = { ["test01"] = { id = "test01" } }, ["map"] = { ["test01"] = { id = "test01" } }, ["weapon"] = { ["test01"] = { id = "test01" } } } }'
