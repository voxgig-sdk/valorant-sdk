...
describe("GameModeDirect", function()
  it("should direct-list-game_mode", function()
    local setup = game_mode_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-game_mode", setup.live and "live" or "unit")
...
function game_mode_direct_setup(mockres)
