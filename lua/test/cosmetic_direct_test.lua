...
describe("CosmeticDirect", function()
  it("should direct-list-cosmetic", function()
    local setup = cosmetic_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-cosmetic", setup.live and "live" or "unit")
...
function cosmetic_direct_setup(mockres)
