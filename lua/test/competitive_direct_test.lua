...
describe("CompetitiveDirect", function()
  it("should direct-list-competitive", function()
    local setup = competitive_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-competitive", setup.live and "live" or "unit")
...
function competitive_direct_setup(mockres)
