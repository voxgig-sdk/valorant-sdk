...
func registerSDKWords(r *eng.Registry, client *sdk.ValorantSDK) {
...
func runOp(client *sdk.ValorantSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
