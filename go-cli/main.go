// Command Valorant-cli is a CLI + REPL for the Valorant SDK,
...
const prompt = "valorant"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "agent competitive cosmetic game_mode map weapon"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      VALORANT_APIKEY (api key), VALORANT_BASE (base url override)")
