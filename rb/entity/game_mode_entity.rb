...
class GameModeEntity
  ...
  def make
    opts = @_entopts.dup
    GameModeEntity.new(@_client, opts)
  end
  ...
  # @return [GameMode, Hash] the current GameMode data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GameMode fields)
  def match_get
  ...
  #
  # @param reqmatch [GameModeListMatch, Hash, nil] match filter (any subset of
  #   GameMode fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<GameMode>, Array] the matching GameMode items; raises ValorantError on failure
