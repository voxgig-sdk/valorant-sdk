...
class CosmeticEntity
  ...
  def make
    opts = @_entopts.dup
    CosmeticEntity.new(@_client, opts)
  end
  ...
  # @return [Cosmetic, Hash] the current Cosmetic data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Cosmetic fields)
  def match_get
  ...
  #
  # @param reqmatch [CosmeticListMatch, Hash, nil] match filter (any subset of
  #   Cosmetic fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Cosmetic>, Array] the matching Cosmetic items; raises ValorantError on failure
