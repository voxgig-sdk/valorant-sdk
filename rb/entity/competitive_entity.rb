...
class CompetitiveEntity
  ...
  def make
    opts = @_entopts.dup
    CompetitiveEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [CompetitiveListMatch, Hash, nil] match filter (any subset of
  #   Competitive fields); defaults to nil, treated as an empty match that lists all.
