...
module ValorantTestRunner
  ...
  def self.env_override(m)
    live = getenv("VALORANT_TEST_LIVE")
    override = getenv("VALORANT_TEST_OVERRIDE")
    ...
    explain = getenv("VALORANT_TEST_EXPLAIN")
    m["VALORANT_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = ValorantTestRunner
Helpers = ValorantHelpers
Vs = VoxgigStruct
