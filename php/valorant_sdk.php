...
class ValorantSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = ValorantHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = ValorantHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!ValorantFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, ValorantFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return ValorantUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = ValorantHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = ValorantHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = ValorantHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new ValorantError($op . "_allow",
                "ValorantSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = ValorantHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new ValorantError("graphql_error",
                "ValorantSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Competitive($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_competitive === null) {
                $this->_competitive = new CompetitiveEntity($this, null);
            }
            return $this->_competitive;
        }
        return new CompetitiveEntity($this, $data);
    }
    ...
    public function Cosmetic($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_cosmetic === null) {
                $this->_cosmetic = new CosmeticEntity($this, null);
            }
            return $this->_cosmetic;
        }
        return new CosmeticEntity($this, $data);
    }
    ...
    public function GameMode($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_game_mode === null) {
                $this->_game_mode = new GameModeEntity($this, null);
            }
            return $this->_game_mode;
        }
        return new GameModeEntity($this, $data);
    }
