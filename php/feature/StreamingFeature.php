...
// Valorant SDK streaming feature
...
class ValorantStreamingFeature extends ValorantBaseFeature
{
    ...
    private function _iterate(ValorantResult $result): \Generator
    {
    ...
    private function _streamable(ValorantContext $ctx): bool
    {
