...
class ValorantFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ValorantSDK/1.0)';
    ...
    public static function call(ValorantContext $ctx, string $fullurl, array $fetchdef): array
    {
