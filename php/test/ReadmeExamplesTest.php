...
// Valorant SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ValorantSDK::test)
...
{
    private const SDK_CLASS = 'ValorantSDK';
    ...
    private const SDK_BASE = 'valorant_sdk';
