...
class GameModeDirectTest extends TestCase
{
    public function test_direct_list_game_mode(): void
    {
        $setup = game_mode_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-game_mode", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
