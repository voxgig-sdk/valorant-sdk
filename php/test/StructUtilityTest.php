...
// Valorant SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ValorantOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ValorantOmni::structfix($now, Struct::undef()))
                        !== json_encode(ValorantOmni::structfix($val, Struct::undef()))) {
