...
class CosmeticDirectTest extends TestCase
{
    public function test_direct_list_cosmetic(): void
    {
        $setup = cosmetic_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-cosmetic", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
