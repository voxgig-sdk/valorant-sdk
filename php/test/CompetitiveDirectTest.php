...
class CompetitiveDirectTest extends TestCase
{
    public function test_direct_list_competitive(): void
    {
        $setup = competitive_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-competitive", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
