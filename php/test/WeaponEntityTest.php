...
class WeaponEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set VALORANT_TEST_WEAPON_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function weapon_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("VALORANT_TEST_WEAPON_ENTID");
