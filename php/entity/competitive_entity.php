...
// Valorant SDK Competitive entity
...
class CompetitiveEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CompetitiveEntity($this->_client, $opts);
    }

    /**
     * @param Competitive|array $args Competitive data (assoc-array) to store.
     */
    ...
    /**
     * @return Competitive|array The current Competitive data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Competitive fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Competitive fields).
     */
     ...
     *
     * @param CompetitiveListMatch|array|null $reqmatch Match filter (any subset
     *   of Competitive fields) as an assoc-array; CompetitiveListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Competitive[]|array A list of Competitive items as assoc-arrays at
